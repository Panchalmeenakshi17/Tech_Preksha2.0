...
export default function Herosection() {
  ...
  return (<div className="flex flex-col justify-between h-full gap-28">
     <Header />
        ...
        <div className="flex flex-col gap-8">
          ...
          {currentTeam ? (
            ...
            <div className="flex gap-6 justify-center">
              <h1 className="text-6xl color1">Event</h1>
              <h1 className="text-6xl color2">Registered</h1>
              </div>
            </>
          ) : (
             <>
            ...
            <NavLink
              to="https://mdehd9hta8p.typeform.com/to/WXcMsQR3"
